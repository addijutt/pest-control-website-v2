...
const TermsPage: React.FC = () => {
  ...
  return (
    <>
        ...
        <section className="py-16 lg:py-24 mt-10 verdana">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h4 className='text-2xl font-bold mb-8'>Terms & Conditions</h4>
          <div className='space-y-2 text-[15px]'>
            <p><strong className='text-[#666666]'>Last updated: </strong>May 15, 2025</p>
            <p>Please read these terms and conditions carefully before using Our Service.</p>
            <h3 className='font-bold text-xl'><br />Interpretation and Definitions</h3>
            <h4 className='font-bold text-lg'><br />Interpretation</h4>
            ...
            <h4 className='font-bold text-lg'><br />Definitions</h4>
            <p>For the purposes of these Terms and Conditions:</p>
            <ul>
              <li>
                <p><strong className='text-[#666666]'>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a
              ...
              <li>
                <p><strong className='text-[#666666]'>Country</strong> refers to: California, United States</p>
              </li>
              <li>
                <p><strong className='text-[#666666]'>Company</strong> (referred to as either; the Company; We, ;Us; Our; in this Agreement) refers to
                  FlowBridge Media (Nexus Quant Labs Ltd.), 2803 Philadelphia Pike, Suite B #1708, Claymont, DE 19703</p>
              </li>
              <li>
                <p><strong className='text-[#666666]'>Device</strong> means any device that can access the Service such as a computer, a cellphone or a
                  digital tablet.</p>
              </li>
              <li>
                <p><strong className='text-[#666666]'>Service</strong> refers to the Website.</p>
              </li>
              <li>
                <p><strong className='text-[#666666]'>Terms and Conditions</strong> (also referred as "Terms" mean these Terms and Conditions that form the
                  entire agreement between You and the Company regarding the use of the Service.</p>
              </li>
              <li>
                <p><strong className='text-[#666666]'>Third-party Social Media Service</strong> means any services or content (including data, information,
                  products or services) provided by a third-party that may be displayed, included or made available by the
                  Service.</p>
              </li>
              <li>
                <p><strong className='text-[#666666]'>Website</strong> refers to Local Pest Experts, accessible from https://localpestexperts.com
                </p>
              </li>
              <li>
                <p><strong className='text-[#666666]'>You</strong> means the individual accessing or using the Service, or the company, or other legal entity
                  on behalf of which such individual is accessing or using the Service, as applicable.</p>
              </li>
            </ul>
            <h3 className='font-bold text-xl'><br />Acknowledgment</h3>
            <p>These are the Terms and Conditions governing the use of this Service and the agreement that operates between You
              ...
              Service.</p>
            <p><br />Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and
              Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the Service.</p>
            <p><br />By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with any
              part of these Terms and Conditions then You may not access the Service.</p>
            <p><br />You represent that you are over the age of 18. The Company does not permit those under 18 to use the Service.
            </p>
            <p><br />Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy
            ...
            <h3 className='font-bold text-xl'><br />Links to Other Websites</h3>
            <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by the Company.
            </p>
            <p><br />The Company has no control over, and assumes no responsibility for, the content, privacy policies, or practices
              ...
              sites or services.</p>
            <p><br />We strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or
              services that You visit.</p>
            <h3 className='font-bold text-xl'><br />Termination</h3>
            ...
            <p><br />Upon termination, Your right to use the Service will cease immediately.</p>
            <h3 className='font-bold text-xl'><br />Limitation of Liability</h3>
            ...
            <p><br />To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for
              ...
              essential purpose.</p>
            <p><br />Some states do not allow the exclusion of implied warranties or limitation of liability for incidental or
            ...
            <h3 className='font-bold text-xl'><br /><strong>Disclaimer</strong></h3>
            <p>By clicking ‘Submit’ or by calling the displayed phone number, you confirm that you are requesting to be connected with our partner network. You agree to our Privacy Policy and Terms of Service, and you understand that your call may be recorded and monitored for quality assurance. All calls are strictly consumer-initiated inbound calls.</p>
            ...
            <p><br />Without limiting the foregoing, neither the Company nor any of the company's provider makes any representation
            ...
            <p><br />Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable
            ...
            <h3 className='font-bold text-xl'><br />Governing Law</h3>
            ...
            <h3 className='font-bold text-xl'><br />Disputes Resolution</h3>
            ...
            <h3 className='font-bold text-xl'><br />For European Union (EU) Users</h3>
            ...
            <h3 className='font-bold text-xl'><br />United States Legal Compliance</h3>
            ...
            <h2><br />Severability and Waiver</h2>
            <h4 className='font-bold text-lg'><br />Severability</h4>
            ...
            <h4 className='font-bold text-lg'><br />Waiver</h4>
            ...
            <h4 className='font-bold text-lg'><br />Translation Interpretation</h4>
            <p>These Terms and Conditions may have been translated if We have made them available to You on our Service.</p>
            <p><br />You agree that the original English text shall prevail in the case of a dispute.</p>
            <h4 className='font-bold text-lg'><br />Changes to These Terms and Conditions</h4>
            ...
            <p><br />By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the
              revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the
              Service.</p>
            <h4 className='font-bold text-lg'><br /><br />Contact Us</h4>
            <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
            <p>By phone number: <a href="tel:6054606263">605-460-6263</a></p>
          </div>
          </div>
        </section>
